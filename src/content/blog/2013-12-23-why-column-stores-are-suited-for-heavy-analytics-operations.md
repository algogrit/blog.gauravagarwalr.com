...
excerpt: Analytics is about data, not just code. Here’s why we moved from MySQL to MonetDB, and how column stores shine for high-dimensional, read-heavy workloads.
---
